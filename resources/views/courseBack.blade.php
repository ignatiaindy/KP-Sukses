                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="why-you-learn">
                                <ul>
                                    ...
                                    <li>
                                        <span>
                                            <i class='bx bx-check'></i>
                                            Mendapatkan pembelajaran bersetifikat
                                        </span>
                                    </li>
                                    <li>
                                        <span>
                                    ...
                                    <li>
                                        <span>
                                            <i class='bx bx-check'></i>
                                            Membantu mempersiapkan diri untuk dunia kerja
                                        </span>
                                    </li>
                        ...
                        <div class="courses-sidebar-syllabus">
                            ...
                            <div class="courses-list">
                                <ul>
                                    <li>
                                        <span class="number">1.</span> Pengenalan Service Repository
                                    </li>
                                    <li>
                    ...
                    <div class="col-lg-4">
                        <div class="courses-sidebar-information">
                            ...
                            <div>
                                <a href="https://bootcamp.sinergipeta.com/" class="default-btn1" target="_blank"target="_blank">Daftar</a>
                            </div> 
